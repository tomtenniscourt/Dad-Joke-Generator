export default function About() {
  return (
    <div className="About">
      ...
      <p>
        This is a simple app that allows users to randomly generate one of 5,000
        ...
        <br />
        <br />
        If the user wishes to remove an individual joke, multiple jokes, or all
        the jokes from the list, there are options available that will allow
        them to do this. For example, there is a 'Remove Selected' button, and a
        'Remove All' button.
        <br />
        <br />
